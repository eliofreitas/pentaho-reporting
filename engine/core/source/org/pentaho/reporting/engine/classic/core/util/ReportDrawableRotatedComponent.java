...
public class ReportDrawableRotatedComponent implements IReportDrawableRotated {
  ...
  public void draw( final Graphics2D graphics2D, final Rectangle2D bounds ) {
    ...
    final Double borderBottomWidth =
      Double.valueOf( element.getStyle().getDoubleStyleProperty( ElementStyleKeys.BORDER_BOTTOM_WIDTH, 0d ) );
    final Double borderTopWidth =
      Double.valueOf( element.getStyle().getDoubleStyleProperty( ElementStyleKeys.BORDER_TOP_WIDTH, 0d ) );
    final Double borderLeftWidth =
      Double.valueOf( element.getStyle().getDoubleStyleProperty( ElementStyleKeys.BORDER_LEFT_WIDTH, 0d ) );
    final Double borderRightWidth =
      Double.valueOf( element.getStyle().getDoubleStyleProperty( ElementStyleKeys.BORDER_RIGHT_WIDTH, 0d ) );
     ...
     * Account for borders */
    float breakWidth;
    if ( this.rotationDegree == 90f || this.rotationDegree == -270f || this.rotationDegree == 270f
      || this.rotationDegree == -90f ) {
      breakWidth =
        (float) bounds.getHeight() - ( s * 2f + borderTopWidth.floatValue() + borderBottomWidth.floatValue() );
    } else if ( this.rotationDegree == 0f || this.rotationDegree == 360f || this.rotationDegree == 180f
      || this.rotationDegree == -180f ) {
      breakWidth =
        (float) bounds.getWidth() - ( s * 2f + borderLeftWidth.floatValue() + borderRightWidth.floatValue() );
    } else {
      breakWidth = (float) ( Math.sqrt( Math.pow(
        ( element.getStyle().getDoubleStyleProperty( ElementStyleKeys.MIN_HEIGHT, 0d ) - borderTopWidth.floatValue()
          - borderBottomWidth.floatValue() ), 2d )
        + Math.pow(
        ( element.getStyle().getDoubleStyleProperty( ElementStyleKeys.MIN_WIDTH, 0d ) - borderLeftWidth.floatValue()
          - borderRightWidth.floatValue() ), 2d ) ) ) - s * 2f;
    }
    ...
    if ( String.valueOf( element.getStyle().getStyleProperty( TextStyleKeys.TEXT_WRAP ) ).equals( "null" ) ||
      String.valueOf( element.getStyle().getStyleProperty( TextStyleKeys.TEXT_WRAP ) )
        .equals( TextWrap.WRAP.toString() ) ) {
    ...
    } else if ( String.valueOf( element.getStyle().getStyleProperty( TextStyleKeys.TEXT_WRAP ) )
      .equals( TextWrap.NONE.toString() ) ) {
    ...
    for ( int i = 0; i < lines.size(); i++ ) {
      ...
      textHeight =
        layout.getAscent() + layout.getDescent() + layout.getLeading();//(float)layout.getBounds().getHeight();
      ...
      if ( this.rotationDegree == 90 || this.rotationDegree == -270 || this.rotationDegree == -90
        ...
        if ( vAlign.equals( "null" ) || vAlign.equals( ElementAlignment.TOP.toString() ) ) {
          translateY = -centerY + ( s + borderTopWidth.floatValue() ) + ( textWidth / 2f ) * (float) Math
            .abs( Math.sin( this.rotationRadian ) ) + ( layout.getAscent() / 2f + layout.getDescent() ) * (float) Math
            .abs( Math.cos( this.rotationRadian ) );
        }
        //} else if (vAlign.equals(String.valueOf(ElementAlignment.MIDDLE))) { Already done
          ...
          translateY = centerY - ( s + borderBottomWidth.floatValue() ) - ( textWidth / 2f ) * (float) Math
            .abs( Math.sin( this.rotationRadian ) ) - ( textHeight / 2f ) * (float) Math
            .abs( Math.cos( this.rotationRadian ) );
        }
        /* horizontal translation (assuming it is the same for all lines) */
        if ( hAlign.equals( "null" ) || hAlign.equals( ElementAlignment.LEFT.toString() ) || hAlign
          .equals( ElementAlignment.JUSTIFY.toString() ) ) {
          translateX = -centerX + ( s + borderLeftWidth.floatValue() ) + ( textWidth / 2f ) * (float) Math
            .abs( Math.cos( this.rotationRadian ) ) + ( textHeight / 2f ) * (float) Math
            .abs( Math.sin( this.rotationRadian ) );
          ...
          translateX = centerX - ( s + borderRightWidth.floatValue() ) - ( textWidth / 2f ) * (float) Math
            .abs( Math.cos( this.rotationRadian ) ) - ( textHeight / 2f ) * (float) Math
            .abs( Math.sin( this.rotationRadian ) );
        ...
        if ( hAlign.equals( "null" ) || hAlign.equals( ElementAlignment.LEFT.toString() ) || hAlign
          .equals( ElementAlignment.JUSTIFY.toString() ) ) {
          translateX = -centerX + ( s + borderLeftWidth.floatValue() ) + ( textWidth / 2f ) * (float) Math
            .abs( Math.cos( this.rotationRadian ) ) + ( layout.getAscent() / 2f + layout.getDescent() ) * (float) Math
            .abs( Math.sin( this.rotationRadian ) );
        ...
        if ( hAlign.equals( "null" ) || hAlign.equals( ElementAlignment.LEFT.toString() ) || hAlign
          ...
          if ( ( this.rotationDegree > 0 && this.rotationDegree <= 180 ) || ( this.rotationDegree > -360
          ...
          if ( lines.size() % 2 == 0 ) {
            if ( ( ( lines.size() / 2 ) - i ) > 0 ) {
              ...
              translateX -= ( ( lines.size() / 2 ) - ( i + 1 ) ) * ( ( textHeight ) / (float) Math
                .abs( Math.sin( this.rotationRadian ) ) );
            } else {
              /* 2nd half */
              translateX = ( ( textHeight ) / (float) Math.abs( Math.sin( this.rotationRadian ) ) ) / 2f;
              translateX +=
                ( i - ( lines.size() / 2 ) ) * ( ( textHeight ) / (float) Math.abs( Math.sin( this.rotationRadian ) ) );
            }
          } else {
            if ( ( ( ( lines.size() - 1 ) / 2 ) - i ) > 0 ) {
              /* 1st half */
              translateX = -( ( ( lines.size() - 1 ) / 2 ) - i ) * ( ( textHeight ) / (float) Math
                .abs( Math.sin( this.rotationRadian ) ) );
            } else if ( ( ( ( lines.size() - 1 ) / 2 ) - i ) < 0 ) {
              /* 2nd half */
              translateX = ( i - ( ( lines.size() - 1 ) / 2 ) ) * ( ( textHeight ) / (float) Math
                .abs( Math.sin( this.rotationRadian ) ) );
            } else if ( ( ( ( lines.size() - 1 ) / 2 ) - i ) == 0 ) {
              /* 1 line in the middle */
              translateX = 0f;
          ...
          translateX -=
            ( lines.size() - 1 - i ) * ( ( textHeight ) / (float) Math.abs( Math.sin( this.rotationRadian ) ) );
        }
      }
  ...
  public Dimension getPreferredSize() {
    if ( element.getStyle().getStyleProperty( ElementStyleKeys.MIN_WIDTH ).getClass().isAssignableFrom( Float.class ) &&
      ...
      return new Dimension( ( (Float) element.getStyle().getStyleProperty( ElementStyleKeys.MIN_WIDTH ) ).intValue(),
        ( (Float) element.getStyle().getStyleProperty( ElementStyleKeys.MIN_HEIGHT ) ).intValue() );
    } else {
      return null;
    }
  }
  ...
  public void startDrawHtml( Object writer ) throws IOException {
    ...
    final String vAlign;
    final String hAlign;
    final String textWrap; //one of "null" or "wrap"
    /* get directions */
    if ( renderBox != null ) {
      vAlign = String.valueOf( renderBox.getStyleSheet().getStyleProperty( ElementStyleKeys.VALIGNMENT ) );
      hAlign = String.valueOf( renderBox.getStyleSheet().getStyleProperty( ElementStyleKeys.ALIGNMENT ) );
      textWrap = String.valueOf( renderBox.getStyleSheet().getStyleProperty( TextStyleKeys.TEXT_WRAP ) );
    } else {
      vAlign = String.valueOf( element.getStyle().getStyleProperty( ElementStyleKeys.VALIGNMENT ) );
      hAlign = String.valueOf( element.getStyle().getStyleProperty( ElementStyleKeys.ALIGNMENT ) );
      if ( element.getStyle() instanceof StyleSheet ) {
        textWrap = String.valueOf( ( (StyleSheet) element.getStyle() ).getStyleProperty( TextStyleKeys.TEXT_WRAP ) );
      } else {
        textWrap = "null";
      }
    }
    ...
    String cos =
      String.valueOf( ( Math.round( 1e5 * Math.cos( -1d * rotationDegree.doubleValue() * Math.PI / 180d ) ) / 1e5 ) ),
    ...
    ( (XmlWriter) writer ).writeText(
      "<div id='" + rotationComponentId + "' style='display: inline-block; white-space: nowrap;'></div>\n" );
    ...
    ( (XmlWriter) writer ).writeText(
      "if( (navigator.userAgent.toLowerCase().indexOf('msie') != -1) && parseInt(navigator.userAgent.toLowerCase()"
        + ".split('msie')[1]) == 8){\n" );

    ( (XmlWriter) writer ).writeText( "window.attachEvent('onload', function(){\n" );

    ( (XmlWriter) writer ).writeText(
      " var borderRightWidth = container.parentNode.currentStyle.borderRightWidth.replace(/([0-9]+)pt/g, function(m,"
        + "g){return Math.round(parseInt(g,10)*96/72);});\n" );
    ( (XmlWriter) writer ).writeText(
      " var borderLeftWidth = container.parentNode.currentStyle.borderLeftWidth.replace(/([0-9]+)pt/g, function(m,g)"
        + "{return Math.round(parseInt(g,10)*96/72);});\n" );
    ( (XmlWriter) writer ).writeText(
      " var borderBottomWidth = container.parentNode.currentStyle.borderBottomWidth.replace(/([0-9]+)pt/g, function"
        + "(m,g){return Math.round(parseInt(g,10)*96/72);});\n" );
    ( (XmlWriter) writer ).writeText(
      " var borderTopWidth = container.parentNode.currentStyle.borderTopWidth.replace(/([0-9]+)pt/g, function(m,g)"
        + "{return Math.round(parseInt(g,10)*96/72);});\n" );
    ...
    if ( textWrap.equals( "null" ) ||  textWrap.equals( TextWrap.WRAP.toString() ) ) {
      ...
      if ( rotationDegree == 90f || rotationDegree == -90f || rotationDegree == 270f || rotationDegree == -270f ) {
        ...
        ( (XmlWriter) writer ).writeText(
          "  containerStyle += ' width: '+( container.parentNode.offsetHeight -(parseInt(borderTopWidth)?parseInt"
            + "(borderTopWidth):0) -(parseInt(borderBottomWidth)?parseInt(borderBottomWidth):0) )+'px;  white-space: "
            + "pre-wrap;';\n" );
        ...
        ( (XmlWriter) writer ).writeText(
          "  containerStyle += ' width: '+( container.parentNode.offsetWidth -(parseInt(borderLeftWidth)?parseInt"
            + "(borderLeftWidth):0) -(parseInt(borderRightWidth)?parseInt(borderRightWidth):0) )+'px; white-space: "
            + "pre-wrap;  ';\n" );
        // set some styling before rotation logic execution
        ( (XmlWriter) writer ).writeText( "  container.setAttribute('style', containerStyle);\n" );
        ( (XmlWriter) writer ).writeText( " }\n" );
        ...
        ( (XmlWriter) writer ).writeText( " var hypo = Math.sqrt("
          + "Math.pow(container.parentNode.offsetWidth -(parseInt(borderLeftWidth)?parseInt(borderLeftWidth):0) -"
          + "(parseInt(borderRightWidth)?parseInt(borderRightWidth):0),2),"
          + "Math.pow(container.parentNode.offsetHeight -(parseInt(borderTopWidth)?parseInt(borderTopWidth):0) -"
          + "(parseInt(borderBottomWidth)?parseInt(borderBottomWidth):0),2));\n" );
    ...
    ( (XmlWriter) writer ).writeText( " containerStyle += ' " + DefaultStyleBuilder.CSSKeys.MS_FILTER.getCssName() + ":"
      + "progid:DXImageTransform.Microsoft.Matrix("
      + " M11=" + cos + ",M12=" + M12 + ",M21=" + sin + ",M22=" + cos
    ...
    if ( hAlign.equals( "null" ) || hAlign.equals( ElementAlignment.LEFT.toString() ) || hAlign
      ...
      if ( this.rotationDegree == 180 || this.rotationDegree == -180 ) {
        ( (XmlWriter) writer ).writeText(
          " h = (container.parentNode.offsetWidth - (parseInt(borderRightWidth)?parseInt(borderRightWidth):0) - "
            + "(parseInt(borderLeftWidth)?parseInt(borderLeftWidth):0) ) - "
            + s + " - container.offsetWidth;\n" );
      } else if ( this.rotationDegree % 90 == 0 ) {
        ( (XmlWriter) writer ).writeText(
          " h = (container.parentNode.offsetWidth - (parseInt(borderRightWidth)?parseInt(borderRightWidth):0) - "
            + "(parseInt(borderLeftWidth)?parseInt(borderLeftWidth):0) ) - "
            + s + " - container.offsetHeight;\n" );
      } else {
        ( (XmlWriter) writer ).writeText(
          " h = (container.parentNode.offsetWidth - (parseInt(borderRightWidth)?parseInt(borderRightWidth):0) - "
            + "(parseInt(borderLeftWidth)?parseInt(borderLeftWidth):0) ) - "
            + s + " - container.offsetWidth*Math.abs(" + cos + ") - container.offsetHeight*Math.abs(" + sin + ");\n" );
      }
    } else if ( hAlign.equals( ElementAlignment.CENTER.toString() ) ) {
      ...
      if ( this.rotationDegree == 180 || this.rotationDegree == -180 ) {
        ( (XmlWriter) writer ).writeText(
          " h = ((container.parentNode.offsetWidth - (parseInt(borderRightWidth)?parseInt(borderRightWidth):0) - "
            + "(parseInt(borderLeftWidth)?parseInt(borderLeftWidth):0) ) - container.offsetWidth) / 2;\n" );
      } else if ( this.rotationDegree % 90 == 0 ) {
        ( (XmlWriter) writer ).writeText(
          " h = ((container.parentNode.offsetWidth - (parseInt(borderRightWidth)?parseInt(borderRightWidth):0) - "
            + "(parseInt(borderLeftWidth)?parseInt(borderLeftWidth):0) ) - container.offsetHeight) / 2;\n" );
      } else {
        ( (XmlWriter) writer ).writeText(
          " h = ((container.parentNode.offsetWidth - (parseInt(borderRightWidth)?parseInt(borderRightWidth):0) - "
            + "(parseInt(borderLeftWidth)?parseInt(borderLeftWidth):0) ) - container.offsetWidth*Math.abs("
            + cos + ") - container.offsetHeight*Math.abs(" + sin + ")) / 2;\n" );
      }
    }
    ...
    if ( vAlign.equals( "null" ) || vAlign.equals( ElementAlignment.TOP.toString() ) ) {
      ...
      if ( this.rotationDegree == 180 || this.rotationDegree == -180 ) {
        ( (XmlWriter) writer ).writeText(
          " v = container.parentNode.offsetHeight - container.offsetHeight - (parseInt(borderBottomWidth)?parseInt"
            + "(borderBottomWidth):0) - "
            + s + ";\n" );
      } else if ( this.rotationDegree % 90 == 0 ) {
        ( (XmlWriter) writer ).writeText(
          " v = container.parentNode.offsetHeight - container.offsetWidth - (parseInt(borderBottomWidth)?parseInt"
            + "(borderBottomWidth):0) - (parseInt(borderTopWidth)?parseInt(borderTopWidth):0) - "
            + s + ";\n" );
      } else {
        ( (XmlWriter) writer ).writeText(
          " v = container.parentNode.offsetHeight - container.offsetWidth*Math.abs(" + cos
            + ") - container.offsetHeight*Math.abs(" + sin
            + ") - (parseInt(borderBottomWidth)?parseInt(borderBottomWidth):0) - " + s + ";\n" );
      }
    } else if ( vAlign.equals( ElementAlignment.MIDDLE.toString() ) ) {
      if ( this.rotationDegree == 90 || this.rotationDegree == -270 || this.rotationDegree == -90
        || this.rotationDegree == 270 ) {
      ...
      if ( this.rotationDegree == 180 || this.rotationDegree == -180 ) {
        ( (XmlWriter) writer ).writeText(
          " v = ( container.parentElement.offsetHeight - (parseInt(borderBottomWidth)?parseInt(borderBottomWidth):0) "
            + "- container.offsetHeight ) / 2;\n" );
      } else if ( this.rotationDegree % 90 == 0 ) {
        ( (XmlWriter) writer ).writeText(
          " v = (container.parentNode.offsetHeight - (parseInt(borderBottomWidth)?parseInt(borderBottomWidth):0) - "
            + "container.offsetWidth) / 2;\n" );
      } else {
        ( (XmlWriter) writer ).writeText(
          " v = (container.parentNode.offsetHeight - (parseInt(borderBottomWidth)?parseInt(borderBottomWidth):0) - "
            + "container.offsetWidth*Math.abs("
            + cos + ") - container.offsetHeight*Math.abs(" + sin + ")) / 2;\n" );
      }
    }
    ...
    ( (XmlWriter) writer ).writeText(
      " var borderBottomWidth = getComputedStyle(container.parentNode,null).getPropertyValue('border-bottom-width');"
        + " if(borderBottomWidth.indexOf('px') > -1){\n"
        + "  borderBottomWidth = borderBottomWidth.replace(/([0-9]+)px/g, function(m,g){return Math.round(parseInt(g,"
        + "10));});\n"
        + " }else if(borderBottomWidth.indexOf('pt') > -1){\n"
        + "  borderBottomWidth = borderBottomWidth.replace(/([0-9]+)pt/g, function(m,g){return Math.round(parseInt(g,"
        + "10)*96/72);});\n"
        + " }\n" );
    ( (XmlWriter) writer ).writeText(
      " var borderTopWidth = getComputedStyle(container.parentNode,null).getPropertyValue('border-top-width');"
        ...
        + "  borderTopWidth = borderTopWidth.replace(/([0-9]+)pt/g, function(m,g){return Math.round(parseInt(g,10)"
        + "*96/72);});\n"
        + " }\n" );
    ( (XmlWriter) writer ).writeText(
      " var borderRightWidth = getComputedStyle(container.parentNode,null).getPropertyValue('border-right-width');\n"
        + " if(borderRightWidth.indexOf('px') > -1){\n"
        + "  borderRightWidth = borderRightWidth.replace(/([0-9]+)px/g, function(m,g){return Math.round(parseInt(g,"
        + "10));});\n"
        + " }else if(borderRightWidth.indexOf('pt') > -1){\n"
        + "  borderRightWidth = borderRightWidth.replace(/([0-9]+)pt/g, function(m,g){return Math.round(parseInt(g,"
        + "10)*96/72);});\n"
        + " }\n" );
    ( (XmlWriter) writer ).writeText(
      " var borderLeftWidth = getComputedStyle(container.parentNode,null).getPropertyValue('border-left-width');\n"
        ...
        + "  borderLeftWidth = borderLeftWidth.replace(/([0-9]+)pt/g, function(m,g){return Math.round(parseInt(g,10)"
        + "*96/72);});\n"
        + " }\n" );
    ...
    if ( textWrap.equals( "null" ) || textWrap.equals( TextWrap.WRAP.toString() ) ) {
      if ( rotationDegree == 90f || rotationDegree == -90f || rotationDegree == 270f || rotationDegree == -270f ) {
        ...
        ( (XmlWriter) writer ).writeText(
          "  containerStyle += ' white-space: pre-wrap;  width: '+( container.parentNode.offsetHeight -(parseInt"
            + "(borderBottomWidth)?parseInt(borderBottomWidth):0) -(parseInt(borderTopWidth)?parseInt(borderTopWidth)"
            + ":0) )+'px;';\n" );
        // set some styling before rotation logic execution
        ( (XmlWriter) writer ).writeText( "  container.setAttribute('style', containerStyle);\n" );
        ( (XmlWriter) writer ).writeText( " }\n" );
        ...
        ( (XmlWriter) writer ).writeText(
          "  containerStyle += ' white-space: pre-wrap;  width: '+( container.parentNode.offsetWidth -(parseInt"
            + "(borderRightWidth)?parseInt(borderRightWidth):0) -(parseInt(borderLeftWidth)?parseInt(borderLeftWidth)"
            + ":0) )+'px;';\n" );
        ( (XmlWriter) writer ).writeText( "  container.setAttribute('style', containerStyle);\n" );
        ( (XmlWriter) writer ).writeText( " }\n" );
      } else { // diagonal
        ...
        // width > hypotenuse
        ( (XmlWriter) writer ).writeText( " var hypo = Math.sqrt("
          + "Math.pow(container.parentNode.offsetWidth -(parseInt(borderRightWidth)?parseInt(borderRightWidth):0) -"
          + "(parseInt(borderLeftWidth)?parseInt(borderLeftWidth):0),2),"
          + "Math.pow(container.parentNode.offsetHeight -(parseInt(borderBottomWidth)?parseInt(borderBottomWidth):0) "
          + "-(parseInt(borderTopWidth)?parseInt(borderTopWidth):0),2));\n" );
        ( (XmlWriter) writer ).writeText( " if (container.offsetWidth > hypo){\n" );
    ...
    /* horizontal translation */
    if ( hAlign.equals( "null" ) || hAlign.equals( String.valueOf( ElementAlignment.LEFT ) ) || hAlign
      .equals( String.valueOf( ElementAlignment.JUSTIFY ) ) ) {
      if ( this.rotationDegree == 180f || this.rotationDegree == -180f ) {
        ( (XmlWriter) writer ).writeText( " containerStyle += ' text-align: right;';\n" );
      }
      ( (XmlWriter) writer ).writeText(
        " mStr += ( -(container.offsetWidth/2) +(container.offsetWidth/2)*Math.abs(" + cos
          + ") +(container.offsetHeight/2)*Math.abs(" + sin + ") )+',';\n" );
    } else if ( hAlign.equals( String.valueOf( ElementAlignment.RIGHT ) ) ) {
      if ( this.rotationDegree == 180f || this.rotationDegree == -180f ) {
        ( (XmlWriter) writer ).writeText( " containerStyle += ' text-align: left;';\n" );
      }
      ...
      ( (XmlWriter) writer ).writeText( " if (container.parentNode.offsetWidth >= container.offsetWidth){\n"
        ...
        + ") -(container.offsetHeight/2)*Math.abs(" + sin + ") )+',';\n"
        + " }else{\n"
        + "   mStr += ( -(container.offsetWidth/2) +(container.parentNode"
        + ".offsetWidth-borderRightWidth-borderLeftWidth-container.offsetHeight) +(container.offsetWidth/2)*Math.abs("
        + cos + ") +(container.offsetHeight/2)*Math.abs(" + sin + ") )+',';\n"
        + " }\n" );
    } else if ( hAlign.equals( String.valueOf( ElementAlignment.CENTER ) ) ) {
      if ( this.rotationDegree != 90f && this.rotationDegree != -270f && this.rotationDegree != -90f
        && this.rotationDegree != 270f && this.rotationDegree != 180f && this.rotationDegree != -180f ) {
        ( (XmlWriter) writer ).writeText( " containerStyle += ' text-align: center;';\n" );
      }
      ( (XmlWriter) writer ).writeText( "  if (container.parentNode.offsetWidth < container.offsetWidth){\n"
    ...
    if ( vAlign.equals( "null" ) || vAlign.equals( String.valueOf( ElementAlignment.TOP ) ) ) {
      ...
      ( (XmlWriter) writer ).writeText(
        " mStr += (-container.offsetTop -container.offsetHeight/2 +(container.offsetHeight/2)*Math.abs(" + cos
          + ") +(container.offsetWidth/2)*Math.abs(" + sin + "))+');';\n" );
      ...
      if ( this.rotationDegree == 180f || this.rotationDegree == -180f ) {
        ...
        ( (XmlWriter) writer ).writeText(
          " mStr += (container.offsetHeight/2 -(container.offsetWidth/2)*Math.abs(" + sin
            + ") -(container.offsetHeight/2)*Math.abs(" + cos + ") -" + s + " )+');';\n" );
      }
    } else if ( vAlign.equals( String.valueOf( ElementAlignment.MIDDLE ) ) ) {
      if ( this.rotationDegree == 90f || this.rotationDegree == -270f || this.rotationDegree == -90f
        || this.rotationDegree == 270f ) {
        ( (XmlWriter) writer ).writeText( " containerStyle += ' text-align: center;';\n" );
      }
      ( (XmlWriter) writer ).writeText( " mStr += '0);';\n" );
    }
